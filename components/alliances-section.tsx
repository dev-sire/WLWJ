  ...
  return (
    <section className="py-24 md:py-32 relative border-t border-white/10 bg-black overflow-hidden">
      <div className="container mx-auto px-6 flex flex-col items-center text-center">
        ...
        <h2 className="text-4xl md:text-5xl font-bold mb-5 text-white tracking-tight">Our Alliances</h2>
        ...
        <Carousel opts={{ loop: true }} plugins={[AutoScroll({ playOnInit: true, speed: 1 })]}>
          <CarouselContent className="ml-0">
            {logos.map((logo) => (
              ...
              >
                <div className="mx-8 flex shrink-0 flex-col items-center justify-center gap-3 group">
                  <div className="p-4 rounded-xl bg-white/5 border border-white/10 transition-all duration-300 group-hover:bg-white/10 group-hover:border-white/20">
                    <img src={logo.image || "/placeholder.svg"} alt={logo.name} className={logo.className} />
                  </div>
